...
const ModalBasketProduct = ({product}:Props) => {
  return (
    <div className='modal_basket_product grid grid-cols-12 justify-center items-center py-4 text-[13px] md:text-[16px]'>
        <div className='relative col-span-2 border-black rounded-sm'><Image src={urlFor(product.product_img[0]).url()} width={120} height={120} style={{objectFit:"contain"}} alt="modal_basket_image"/></div>
