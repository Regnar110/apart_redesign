    ...
    <div className='block w-full'>
        ...
        <div className=' flex flex-wrap justify-center w-full '>
        {
            products.map((el,i) => { //1024px
                return (
                    <div className='flex flex-col justify-center items-center lg:w-1/3 w-full break-words'>
                        <MediaQuery maxWidth={1024}>
                            <Image src={el[1]} style={{objectFit:"contain", width:"100%"}} key={i} alt={"product_presentation_image"}/>
                        </MediaQuery>
                        <MediaQuery minWidth={1024}>
                            <Image src={el[0]} width={630} height={630} style={{objectFit:"contain"}} key={i} alt={"product_presentation_image"}/>
                        </MediaQuery>
                        ...
                        <CustomTextButton textContent='asdad' isArrow={true} hrefQuery='/'/>                        
                    </div>
